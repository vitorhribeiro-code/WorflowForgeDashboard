...
// Lê e valida o corpo JSON; corpo vazio/ inválido → BAD_INPUT.
...
// Controlador fino: sessão → handler → mapeia erros num só sítio.
// Passa o contexto do App Router (params) ao handler.
